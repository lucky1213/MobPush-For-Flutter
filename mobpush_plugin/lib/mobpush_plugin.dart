...
class MobpushPlugin {
  ...
  static const MethodChannel _channel =
      const MethodChannel('com.mob.mobpush.methodChannel');
  static EventChannel _channelReciever =
      const EventChannel('com.mob.mobpush.reciever');
  ...
  /*
	 ...
	 */
  static Future<void> addPushReceiver(
      EventHandler onEvent, EventHandler onError) async {
  ...
  static Future<void> addLocalNotification(
    ...
    return await _channel.invokeMethod('addLocalNotification',
...
// IOS API
  ...
  static Future<void> setAPNsForProduction(bool isPro) async {
    return await _channel
        .invokeMethod('setAPNsForProduction', {'isPro': isPro});
  }
  ...
  static Future<void> setAPNsShowForegroundType(int type) async {
    return await _channel
        .invokeMethod('setAPNsShowForegroundType', {'type': type});
  }
