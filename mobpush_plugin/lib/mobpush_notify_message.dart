...
// Android Properties
  ...
  factory MobPushNotifyMessage.fromJson(Map<String, dynamic> json) {
    return MobPushNotifyMessage(
      ...
      voice: json['voice'],
      shake: json['shake'],
      extrasMap: json.containsKey('extra') ? json['extra'] : json['extrasMap'],
  ...
  factory MobPushNotifyMessage.fromHuawei(Map<String, dynamic> json) {
    return MobPushNotifyMessage(
      content: json['content'] ?? '',
      messageId: null,
      extrasMap: json.containsKey('pushData')
          ? {
